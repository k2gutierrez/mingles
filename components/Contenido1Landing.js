            ...
            <div className='row align-items-center mb-md-4 mb-2'>
                <div className='col-md-4 col-sm-6 col-12'>
                    ...
                    <div className='mt-4'>
                        ...
                        <button type="button" className={cls(fontAgrandir.className, styles.buttons, "btn btn-outline-dark ms-1")} >Join Mingles</button>
                    </div>
                </div>
                <div className='col-md-4 col-6'>
                    <Image className={cls(styles.wormImg, 'img-fluid')} src={WormCircle} alt='Mingle' width={500} height={500} />
                </div>
                <div className='col-md-4 col-sm-12 col-6 pt-4'>
                    <div className='row'>
                        <p className={cls(fontQuirky.className, styles.nftproject)}>NFT PROJECT</p>
                        <p className={cls(fontAgrandir.className, styles.textNftProject)}>4,000 Mingles Tequila <br/> Wormson Ethereum</p>
                    </div>
                    <Slider />
                </div>
            </div>
